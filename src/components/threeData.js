...
const tableData = [
    ...
    // skills
      `
      <div class="btn-style" style="font-size:30px; margin:10px;">Skills</div>
      <div class="css3d-flex">
      <span class="btn-style css3d-flex-child" data-level="Intermediate">JavaScript</span>        <div class="btn-style css3d-flex-child" data-level="Intermediate">Node.js</div>          <div class="btn-style css3d-flex-child" data-level="Intermediate">React</div> 
      ...
      <div class="css3d-flex">
      <div class="btn-style css3d-flex-child" data-level="Intermediate">MySql</div>               <div class="btn-style css3d-flex-child" data-level="Intermediate">Windows MFC</div>      <div class="btn-style css3d-flex-child" data-level="Intermediate">Unity</div> 
      <div class="btn-style css3d-flex-child" data-level="Intermediate">Sequelize ORM</div> <br/> <div class="btn-style css3d-flex-child" data-level="Intermediate">Win32api</div>         <div class="btn-style css3d-flex-child" data-level="Intermediate">Express</div>
      </div>
      <div class="css3d-flex">
      <div class="btn-style css3d-flex-child" data-level="Intermediate">C++</div>                 <div class="btn-style css3d-flex-child" data-level="Intermediate">C#</div>                  
      <div class="btn-style css3d-flex-child" data-level="Intermediate">Netlify Platform</div>    <div class="btn-style css3d-flex-child" data-level="Intermediate">Sequelize ORM</div> <br/>
      </div>
      `,
];
